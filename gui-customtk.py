...
class DocumentSearchApp:
    def __init__(self, master):
        ...
        self.target_word_label = customtkinter.CTkLabel(master, text="Target Word:")
        self.target_word_label.pack()

        self.target_word_entry = customtkinter.CTkEntry(master)
        self.target_word_entry.pack()

        self.browse_button = customtkinter.CTkButton(master, text="Browse", command=self.browse_directory)
